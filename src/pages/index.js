...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Wonderful Portfolio</title>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-400">
              ...
              with talented people to create digital producta for both business
              and consumer use.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800  dark:text-gray-400">
          ...
          <div className="lg:flex gap-10">
            <div className=" flex flex-col items-center text-center shadow-lg dark:shadow-2xl p-10 rounded-xl my-10 ">
